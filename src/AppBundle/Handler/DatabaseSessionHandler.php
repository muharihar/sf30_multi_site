...
class DatabaseSessionHandler implements \SessionHandlerInterface
{
    ...
    public function __construct($pdoOrDsn = null, array $options = array())
    {
        ...
        $this->ipAddressCol = isset($options['db_ip_address_col']) ? $options['db_ip_address_col'] : $this->ipAddressCol;
    ...
    public function write($sessionId, $data)
    {
        ...
        try {
            ...
            $updateStmt = $this->pdo->prepare(
                "UPDATE $this->table SET $this->dataCol = :data, $this->lifetimeCol = :lifetime, $this->timeCol = :time WHERE $this->idCol = :id, $this->ipAddressCol = :ip_addess"
            );
            ...
            if (!$updateStmt->rowCount()) {
                try {
                    $insertStmt = $this->pdo->prepare(
                        "INSERT INTO $this->table ($this->idCol, $this->dataCol, $this->lifetimeCol, $this->timeCol, $this->ipAddressCol) VALUES (:id, :data, :lifetime, :time, :ip_address)"
                    );
    ...
    private function getMergeSql()
    {
        switch ($this->driver) {
            case 'mysql':
                return "INSERT INTO $this->table ($this->idCol, $this->dataCol, $this->lifetimeCol, $this->timeCol, $this->ipAddressCol) VALUES (:id, :data, :lifetime, :time, :ip_address) ".
                    "ON DUPLICATE KEY UPDATE $this->dataCol = VALUES($this->dataCol), $this->lifetimeCol = VALUES($this->lifetimeCol), $this->timeCol = VALUES($this->timeCol), $this->ipAddressCol = VALUES($this->ipAddressCol)";
            case 'oci':
